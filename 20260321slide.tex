...
\titlepage %表紙
\includemedia[
  addresource=voice/slide01_slow.wav,
  flashvars={
    source=voice/slide01_slow.wav
   &autoPlay=true
  },
  transparent
...
\end{block}
\includemedia[
  addresource=voice/slide02_slow.wav,
  flashvars={
    source=voice/slide02_slow.wav
   &autoPlay=true
  },
  transparent
]{\color{blue}{\tiny\fbox{Play}}}{APlayer.swf}
...
\end{block}
\includemedia[
  addresource=voice/slide03_slow.wav,
  flashvars={
    source=voice/slide03_slow.wav
   &autoPlay=true
  },
  transparent
]{\color{blue}{\tiny\fbox{Play}}}{APlayer.swf}
...
\begin{block}{Transtation Books in Japanese}
\begin{itemize}
...
\begin{block}{Supervised Books in Japanese}
\begin{itemize}
...
\end{block}
\includemedia[
  addresource=voice/slide04_slow.wav,
  flashvars={
    source=voice/slide04_slow.wav
   &autoPlay=true
  },
  transparent
]{\color{blue}{\tiny\fbox{Play}}}{APlayer.swf}
...
\includemedia[
  addresource=voice/slide05_slow.wav,
  flashvars={
    source=voice/slide05_slow.wav
   &autoPlay=true
  },
  transparent
]{\color{blue}{\tiny\fbox{Play}}}{APlayer.swf}
